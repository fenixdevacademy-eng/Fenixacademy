# 🚀 **Projeto Prático - Backend Developer Intermediário**

## 🎯 **Objetivo do Projeto**

Desenvolver uma aplicação completa que demonstre todos os conceitos aprendidos nos módulos 6-10.
...
```
projeto-avaliacao-intermediario/
├── frontend/
│   ├── src/
│   ├── public/
│   └── package.json
