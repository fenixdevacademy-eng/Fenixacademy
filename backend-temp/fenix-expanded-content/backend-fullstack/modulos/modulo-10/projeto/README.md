...
Desenvolver **CRUD com SQLite** aplicando todos os conceitos de **Database** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Database**
...
*Projeto do Módulo 10 - CRUD com SQLite*
