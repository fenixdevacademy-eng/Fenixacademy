# 🚀 **Projeto: API REST Básica**

## 🎯 **Objetivo do Projeto**

Desenvolver **API REST Básica** aplicando todos os conceitos de **Express.js** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Express.js**
...
*Projeto do Módulo 02 - API REST Básica*
