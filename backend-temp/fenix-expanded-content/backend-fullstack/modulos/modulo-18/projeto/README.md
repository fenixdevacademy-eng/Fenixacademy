# 🚀 **Projeto: Containerização**

## 🎯 **Objetivo do Projeto**

Desenvolver **Containerização** aplicando todos os conceitos de **Docker** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Docker**
...
*Projeto do Módulo 18 - Containerização*
