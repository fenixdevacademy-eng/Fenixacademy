# 🚀 **Projeto: API Estruturada**

## 🎯 **Objetivo do Projeto**

Desenvolver **API Estruturada** aplicando todos os conceitos de **Routing** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Routing**
...
*Projeto do Módulo 04 - API Estruturada*
