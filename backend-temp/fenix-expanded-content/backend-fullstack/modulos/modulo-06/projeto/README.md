...
Desenvolver **File Server** aplicando todos os conceitos de **Static Files** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Static Files**
...
*Projeto do Módulo 06 - File Server*
