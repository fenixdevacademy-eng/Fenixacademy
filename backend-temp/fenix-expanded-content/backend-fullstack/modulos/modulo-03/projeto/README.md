# 🚀 **Projeto: Auth Middleware**

## 🎯 **Objetivo do Projeto**

Desenvolver **Auth Middleware** aplicando todos os conceitos de **Middleware** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Middleware**
...
*Projeto do Módulo 03 - Auth Middleware*
