...
Desenvolver **API Completa** aplicando todos os conceitos de **REST APIs** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **REST APIs**
...
*Projeto do Módulo 13 - API Completa*
