# 🚀 **Projeto: Error Management**

## 🎯 **Objetivo do Projeto**

Desenvolver **Error Management** aplicando todos os conceitos de **Error Handling** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Error Handling**
...
*Projeto do Módulo 15 - Error Management*
