...
Desenvolver **Servidor HTTP** aplicando todos os conceitos de **Node.js Básico** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Node.js Básico**
...
*Projeto do Módulo 01 - Servidor HTTP*
