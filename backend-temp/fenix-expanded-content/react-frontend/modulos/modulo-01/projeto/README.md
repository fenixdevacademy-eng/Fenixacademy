# 🚀 **Projeto: Componente Básico**

## 🎯 **Objetivo do Projeto**

Desenvolver **Componente Básico** aplicando todos os conceitos de **React Fundamentos** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **React Fundamentos**
...
*Projeto do Módulo 01 - Componente Básico*
