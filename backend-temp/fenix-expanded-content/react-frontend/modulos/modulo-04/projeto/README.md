...
Desenvolver **Formulário Dinâmico** aplicando todos os conceitos de **Event Handling** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Event Handling**
...
*Projeto do Módulo 04 - Formulário Dinâmico*
