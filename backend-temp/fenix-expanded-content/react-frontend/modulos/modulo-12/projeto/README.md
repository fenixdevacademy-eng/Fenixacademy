...
Desenvolver **Shopping Cart** aplicando todos os conceitos de **State Management** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **State Management**
...
*Projeto do Módulo 12 - Shopping Cart*
