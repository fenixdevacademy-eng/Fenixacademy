...
Desenvolver **Lista de Produtos** aplicando todos os conceitos de **JSX e Props** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **JSX e Props**
...
*Projeto do Módulo 02 - Lista de Produtos*
