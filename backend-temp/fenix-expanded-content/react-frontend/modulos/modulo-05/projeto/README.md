# 🚀 **Projeto: Timer Component**

## 🎯 **Objetivo do Projeto**

Desenvolver **Timer Component** aplicando todos os conceitos de **Lifecycle** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Lifecycle**
...
*Projeto do Módulo 05 - Timer Component*
