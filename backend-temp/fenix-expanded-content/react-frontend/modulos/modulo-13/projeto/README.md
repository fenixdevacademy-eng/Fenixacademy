# 🚀 **Projeto: Redux Counter**

## 🎯 **Objetivo do Projeto**

Desenvolver **Redux Counter** aplicando todos os conceitos de **Redux Básico** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Redux Básico**
...
*Projeto do Módulo 13 - Redux Counter*
