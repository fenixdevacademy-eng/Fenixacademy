...
Desenvolver **Redux Todo** aplicando todos os conceitos de **Redux Toolkit** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Redux Toolkit**
...
*Projeto do Módulo 14 - Redux Todo*
