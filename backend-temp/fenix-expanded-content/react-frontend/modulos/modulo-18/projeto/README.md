# 🚀 **Projeto: App TypeScript**

## 🎯 **Objetivo do Projeto**

Desenvolver **App TypeScript** aplicando todos os conceitos de **TypeScript** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **TypeScript**
...
*Projeto do Módulo 18 - App TypeScript*
