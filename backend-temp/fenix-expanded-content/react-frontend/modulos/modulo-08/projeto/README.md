...
Desenvolver **Theme Switcher** aplicando todos os conceitos de **Context API** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Context API**
...
*Projeto do Módulo 08 - Theme Switcher*
