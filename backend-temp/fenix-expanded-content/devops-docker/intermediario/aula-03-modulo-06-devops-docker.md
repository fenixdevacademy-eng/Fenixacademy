...
## 📚 **Aula 03 - Módulo 06: Service Mesh
...
Imagine que você está trabalhando na Santander e precisa implementar uma solução robusta de **Service Mesh** para sistemas modernos. Esta é uma das tecnologias fundamentais que você precisa dominar para criar soluções modernas, escaláveis e de alta qualidade.
...
**Contexto e Desafio**
A Santander precisava implementar uma solução robusta de Service Mesh para sistemas modernos, enfrentando desafios de escalabilidade e performance.
...
Desenvolva uma solução para a Santander que precisa implementar **Service Mesh** em sua plataforma. A empresa enfrenta desafios de performance e escalabilidade.
...
Implemente uma solução completa de **Service Mesh** para a Santander:
...
**Requisitos Técnicos:**
- Processamento de 1917 registros por minuto
