...
Desenvolver **Blog Responsivo** aplicando todos os conceitos de **Responsive Design** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Responsive Design**
...
*Projeto do Módulo 08 - Blog Responsivo*
