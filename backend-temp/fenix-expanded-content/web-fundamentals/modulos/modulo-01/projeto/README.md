...
Desenvolver **Portfólio Pessoal** aplicando todos os conceitos de **HTML5 Semântico** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **HTML5 Semântico**
...
*Projeto do Módulo 01 - Portfólio Pessoal*
