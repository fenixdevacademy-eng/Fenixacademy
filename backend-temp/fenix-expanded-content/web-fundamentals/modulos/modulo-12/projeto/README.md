# 🚀 **Projeto: Geolocalização App**

## 🎯 **Objetivo do Projeto**

Desenvolver **Geolocalização App** aplicando todos os conceitos de **Web APIs** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Web APIs**
...
*Projeto do Módulo 12 - Geolocalização App*
