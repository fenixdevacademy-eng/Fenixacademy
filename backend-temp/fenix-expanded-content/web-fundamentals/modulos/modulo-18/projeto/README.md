# 🚀 **Projeto: Setup Webpack**

## 🎯 **Objetivo do Projeto**

Desenvolver **Setup Webpack** aplicando todos os conceitos de **Build Tools** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Build Tools**
...
*Projeto do Módulo 18 - Setup Webpack*
