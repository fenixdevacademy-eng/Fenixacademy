...
Desenvolver **To-Do List** aplicando todos os conceitos de **DOM Manipulation** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **DOM Manipulation**
...
*Projeto do Módulo 04 - To-Do List*
