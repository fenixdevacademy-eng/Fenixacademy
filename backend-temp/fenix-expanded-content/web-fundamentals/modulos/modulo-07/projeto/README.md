...
Desenvolver **Notas App** aplicando todos os conceitos de **Local Storage** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Local Storage**
...
*Projeto do Módulo 07 - Notas App*
