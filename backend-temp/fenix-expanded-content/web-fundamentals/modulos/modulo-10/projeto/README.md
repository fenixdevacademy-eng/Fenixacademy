...
Desenvolver **Galeria de Fotos** aplicando todos os conceitos de **CSS Flexbox** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **CSS Flexbox**
...
*Projeto do Módulo 10 - Galeria de Fotos*
