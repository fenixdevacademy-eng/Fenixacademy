# 🚀 **Projeto: Portfólio Animado**

## 🎯 **Objetivo do Projeto**

Desenvolver **Portfólio Animado** aplicando todos os conceitos de **Animations CSS** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Animations CSS**
...
*Projeto do Módulo 11 - Portfólio Animado*
