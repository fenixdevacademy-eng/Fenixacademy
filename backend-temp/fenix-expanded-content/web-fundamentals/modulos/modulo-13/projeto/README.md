# 🚀 **Projeto: Site Otimizado**

## 🎯 **Objetivo do Projeto**

Desenvolver **Site Otimizado** aplicando todos os conceitos de **Performance** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **Performance**
...
*Projeto do Módulo 13 - Site Otimizado*
