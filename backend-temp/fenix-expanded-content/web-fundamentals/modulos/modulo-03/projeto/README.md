...
Desenvolver **Calculadora Interativa** aplicando todos os conceitos de **JavaScript Básico** aprendidos no módulo.

## 📋 **Especificações do Projeto**

### **Funcionalidades Obrigatórias**
- ✅ Implementação completa de **JavaScript Básico**
...
*Projeto do Módulo 03 - Calculadora Interativa*
