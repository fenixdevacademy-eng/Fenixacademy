# 🎓 **Sistema de Avaliação - Web Fundamentals**
...
#### **Iniciante**
- **Módulos:** 1-5
- **Certificado:** Web Developer Iniciante
- **Avaliação:** [Avaliação Iniciante](./iniciante/)

#### **Intermediario**
- **Módulos:** 6-10
- **Certificado:** Web Developer Intermediário
- **Avaliação:** [Avaliação Intermediario](./intermediario/)

#### **Avancado**
- **Módulos:** 11-15
- **Certificado:** Web Developer Avançado
- **Avaliação:** [Avaliação Avancado](./avancado/)

#### **Expert**
- **Módulos:** 16-20
- **Certificado:** Web Developer Expert
...
- **Web Developer Iniciante** - Validação de conhecimento iniciante
- **Web Developer Intermediário** - Validação de conhecimento intermediario
- **Web Developer Avançado** - Validação de conhecimento avancado
- **Web Developer Expert** - Validação de conhecimento expert
