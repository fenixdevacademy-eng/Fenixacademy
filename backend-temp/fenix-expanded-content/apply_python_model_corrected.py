#!/usr/bin/env python3
"""
Script corrigido para aplicar o modelo de estudo do Python Data Science para todos os cursos
Usa os nomes corretos dos diretórios existentes
"""
...
class CourseModelApplier:
    ...
    def load_course_configs(self) -> Dict[str, Dict[str, Any]]:
        """Carrega configurações específicas de cada curso usando nomes corretos dos diretórios"""
        return {
            "web-fundamentals": {
                "emoji": "🌐",
                ...
                "topics": [
                    ...
                    "Web APIs", "Service Workers", "WebAssembly", "GraphQL",
                    "REST APIs", "Microservices", "Docker", "CI/CD"
                ],
            ...
            "python-data-science": {
                ...
                "topics": [
                    ...
                    "Deploy de Modelos", "Otimização de Performance", "Scikit-learn",
                    "TensorFlow", "PyTorch", "Jupyter Notebooks", "Matplotlib",
                    "Seaborn", "Plotly", "Streamlit", "FastAPI", "Docker"
                ],
            ...
            "react-advanced": {
                ...
                "topics": [
                    ...
                    "TypeScript", "Next.js", "Gatsby", "Storybook", "Jest",
                    "React Query", "Zustand", "Framer Motion", "React Hook Form"
                ],
            ...
            "aws-cloud": {
                ...
                "topics": [
                    ...
                    "API Gateway", "SQS e SNS", "ElastiCache", "Route 53",
                    "CloudFront", "WAF", "KMS", "Secrets Manager"
                ],
            ...
            "machine-learning": {
                ...
                "topics": [
                    ...
                    "LightGBM", "MLflow", "Kubeflow", "Seldon"
                ],
            ...
            "cybersecurity": {
                ...
                "topics": [
                    ...
                    "OWASP", "NIST", "ISO 27001", "SOC", "SIEM", "EDR", "XDR"
                ],
            ...
            "flutter-mobile": {
                ...
                "topics": [
                    ...
                    "Bloc", "Provider", "Riverpod", "GetX", "Hive",
                    "SQLite", "REST APIs", "GraphQL", "Push Notifications"
                ],
            ...
            "blockchain-smart-contracts": {
                ...
                "topics": [
                    ...
                    "IPFS", "The Graph", "OpenZeppelin", "Hardhat", "Truffle",
                    "MetaMask", "WalletConnect", "Uniswap", "Compound"
                ],
            ...
            "react-native-mobile": {
                ...
                "topics": [
                    ...
                    "Code Push", "Analytics", "Redux", "MobX", "Context API",
                    "AsyncStorage", "SQLite", "Realm", "Firebase", "Expo"
                ],
                "companies": ["iFood", "99", "Rappi"],
            ...
            "data-science": {
                ...
                "topics": [
                    ...
                    "A/B Testing", "Data Storytelling", "Python", "R", "SQL",
            ...
            "game-development": {
                ...
                "topics": [
                    ...
                    "Game Analytics", "Monetization", "Unreal Engine", "Godot",
                    "Blender", "Maya", "Photoshop", "Audacity", "FMOD"
                ],
            ...
            "ui-ux-design": {
                ...
                "topics": [
                    ...
                    "Mobile Design", "Web Design", "Design Tools", "Figma",
                    "Sketch", "Adobe XD", "Principle", "Framer", "InVision"
                ],
            ...
            "frontend-development": {
                ...
                "topics": [
                    ...
                    "Accessibility", "PWA", "Mobile First", "Angular",
                    "Svelte", "Next.js", "Nuxt.js", "Gatsby", "Vite"
                ],
                "companies": ["iFood", "99", "Rappi"],
            ...
            "full-stack-development": {
                ...
                "topics": [
                    ...
                    "Microservices", "GraphQL", "Redis", "Kubernetes"
                ],
            ...
            "product-management": {
                ...
                "topics": [
                    ...
                    "Jira", "Confluence", "Figma", "Mixpanel", "Amplitude",
                    "Google Analytics", "Hotjar", "UserVoice", "ProductBoard"
                ],
            ...
            "gestao-trafego": {
                ...
                "topics": [
                    ...
                    "Google Analytics", "Tag Manager", "Search Console", "Bing Ads",
                    "LinkedIn Ads", "Twitter Ads", "TikTok Ads", "YouTube Ads"
                ],
...
"""
    ...
    def get_context_for_topic(self, topic: str) -> str:
        ...
        contexts = {
            ...
            "Hooks Avançados": "desenvolvimento React",
...
export default {topic.replace(' ', '')};"""
    ...
    def apply_model_to_all_courses(self):
        ...
        # Mapeia os nomes dos cursos para os diretórios existentes
        course_directories = {
        ...
        for course_key, config in self.course_configs.items():
            ...
            # Usa o nome correto do diretório
            course_dir = course_directories.get(course_key, course_key)
            course_path = self.base_path / course_dir
            
            if not course_path.exists():
                print(f"❌ Diretório do curso {course_dir} não encontrado")
                continue
            ...
            for level in ["iniciante", "intermediario", "avancado"]:
                ...
                if not level_path.exists():
                    print(f"❌ Diretório {level} não encontrado para {course_dir}")
                    continue
                ...
                for module in range(1, 21):
                    ...
                    for lesson in range(1, 6):
                        lesson_filename = f"aula-{lesson:02d}-modulo-{module:02d}-{course_dir}.md"
        ...
        print(f"  - Total de aulas geradas: {total_lessons}")
