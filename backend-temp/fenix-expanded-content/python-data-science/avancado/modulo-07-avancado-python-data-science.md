...
- Dominar conceitos fundamentais de big data com pyspark
...
### 3. DataFrames no Spark

### 4. Machine Learning no Spark

### 5. Projeto: Análise de Big Data
...
### **Exemplo Básico**
```python
# Exemplo prático de big data com pyspark
import pandas as pd
import numpy as np
...
Você concluiu o módulo **Big Data com PySpark**! 
