# Projeto do Módulo 6: Projeto Final: Infraestrutura na Nuvem

## Visão Geral

Este projeto tem como objetivo consolidar todos os conhecimentos adquiridos no módulo 6, aplicando os conceitos teóricos em uma aplicação prática e real.
...
mkdir projeto-final:-infraestrutura-na-nuvem
cd projeto-final:-infraestrutura-na-nuvem
