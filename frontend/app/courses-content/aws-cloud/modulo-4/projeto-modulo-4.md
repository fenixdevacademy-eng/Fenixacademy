# Projeto do Módulo 4: Monitoramento de Recursos

## Visão Geral

Este projeto tem como objetivo consolidar todos os conhecimentos adquiridos no módulo 4, aplicando os conceitos teóricos em uma aplicação prática e real.
...
mkdir monitoramento-de-recursos
cd monitoramento-de-recursos
