# Módulo 4: CI/CD com Jenkins/GitLab
## Aula 2: CI/CD com Jenkins/GitLab

### Objetivos da Aula
- Compreender os conceitos fundamentais de ci/cd com jenkins/gitlab
...
CI/CD com Jenkins/GitLab é um conceito fundamental que forma a base para o desenvolvimento de habilidades mais avançadas. Nesta aula, vamos explorar os aspectos teóricos e práticos desta tecnologia.
...
```javascript
// Exemplo de código
const example = new CI/CDcomJenkins/GitLab();
example.initialize();
example.process();
```
...
#### Questões Teóricas
1. Explique o conceito de ci/cd com jenkins/gitlab
