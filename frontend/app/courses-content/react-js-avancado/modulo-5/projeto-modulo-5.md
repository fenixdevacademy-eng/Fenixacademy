# Projeto do Módulo 5: Projeto Final: Dashboard Avançado

## Visão Geral

Este projeto tem como objetivo consolidar todos os conhecimentos adquiridos no módulo 5, aplicando os conceitos teóricos em uma aplicação prática e real.
...
mkdir projeto-final:-dashboard-avançado
cd projeto-final:-dashboard-avançado
