// Script de build DEFINITIVO que resolve TODOS os problemas
const fs = require('fs');
const path = require('path');
const { execSync } = require('child_process');

console.log('🚀 Iniciando build DEFINITIVO...');
...
try {
  ...
  // Lista DEFINITIVA de TODOS os arquivos/diretórios problemáticos
  const problematicPaths = [
    // TODA a pasta API (contém process.cwd() e path.join problemáticos)
    'app/api',
    
    // TODAS as rotas dinâmicas que podem ter problemas
    ...
    // Arquivos específicos que podem causar problemas
