# AWS Cloud Practitioner - Orquestração - Aula 16
...
Esta aula é parte do módulo "Orquestração" do curso AWS Cloud Practitioner. Aqui você aprenderá conceitos essenciais de forma prática e didática.
