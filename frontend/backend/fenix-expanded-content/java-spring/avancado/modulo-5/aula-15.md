# Java & Spring Boot - Autenticação e Segurança - Aula 15
...
Esta aula é parte do módulo "Autenticação e Segurança" do curso Java & Spring Boot. Aqui você aprenderá conceitos essenciais de forma prática e didática.
...
**Descrição:** Desenvolva aplicações enterprise com Java e Spring Boot
...
*Esta aula faz parte do curso Java & Spring Boot da Fênix Academy. Continue praticando e não hesite em pedir ajuda na nossa comunidade!*
