# React Completo - Fundamentos e Configuração - Aula 20
...
Esta aula é parte do módulo "Fundamentos e Configuração" do curso React Completo. Aqui você aprenderá conceitos essenciais de forma prática e didática.
...
**Descrição:** Desenvolva aplicações modernas com React, Hooks e Context API
...
*Esta aula faz parte do curso React Completo da Fênix Academy. Continue praticando e não hesite em pedir ajuda na nossa comunidade!*
