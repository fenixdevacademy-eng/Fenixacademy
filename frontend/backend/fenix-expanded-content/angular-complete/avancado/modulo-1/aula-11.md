# Angular Completo - Fundamentos e Configuração - Aula 11
...
Esta aula é parte do módulo "Fundamentos e Configuração" do curso Angular Completo. Aqui você aprenderá conceitos essenciais de forma prática e didática.
...
**Descrição:** Crie aplicações enterprise com Angular, RxJS e NgRx
...
*Esta aula faz parte do curso Angular Completo da Fênix Academy. Continue praticando e não hesite em pedir ajuda na nossa comunidade!*
