# NestJS Completo - Autenticação e Segurança - Aula 18
...
Esta aula é parte do módulo "Autenticação e Segurança" do curso NestJS Completo. Aqui você aprenderá conceitos essenciais de forma prática e didática.
...
**Descrição:** Desenvolva APIs escaláveis com NestJS, TypeORM e microserviços
...
*Esta aula faz parte do curso NestJS Completo da Fênix Academy. Continue praticando e não hesite em pedir ajuda na nossa comunidade!*
