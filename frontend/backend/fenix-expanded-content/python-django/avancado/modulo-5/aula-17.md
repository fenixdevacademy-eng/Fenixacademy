# Python & Django - Autenticação e Segurança - Aula 17
...
Esta aula é parte do módulo "Autenticação e Segurança" do curso Python & Django. Aqui você aprenderá conceitos essenciais de forma prática e didática.
...
**Descrição:** Crie aplicações web robustas com Python e Django
...
*Esta aula faz parte do curso Python & Django da Fênix Academy. Continue praticando e não hesite em pedir ajuda na nossa comunidade!*
