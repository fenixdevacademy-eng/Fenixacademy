"""
Django settings for local development without Docker
"""
...
# Debug Toolbar configuration for local development
...
# Garantir que debug_toolbar está configurado corretamente
