...
- Dominar conceitos fundamentais de machine learning básico
...
### 7. Projeto: Sistema de Recomendação
...
### **Exemplo Básico**
```python
# Exemplo prático de machine learning básico
import pandas as pd
import numpy as np
...
Você concluiu o módulo **Machine Learning Básico**! 
