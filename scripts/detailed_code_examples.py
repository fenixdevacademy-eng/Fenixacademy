...
class DetailedCodeExamples:
    ...
    def get_backend_example(self, lesson_data: Dict[str, Any]) -> str:
        ...
        return f"""// Sistema Backend Completo - {lesson_data.get('title', 'Aula')}
// Curso: {lesson_data.get('course', 'Curso')}
// Módulo: {lesson_data.get('module', 'Módulo')}
  ...
  async getExemplo(req, res) {{
    try {{
      res.json({{
        ...
        data: {{
          timestamp: new Date().toISOString(),
          lesson: '{lesson_data.get('title', 'Aula')}',
...
"""
    ...
    def get_data_science_example(self, lesson_data: Dict[str, Any]) -> str:
        ...
        return f"""# Análise de Dados Completa - {lesson_data.get('title', 'Aula')}
# Curso: {lesson_data.get('course', 'Curso')}
# Módulo: {lesson_data.get('module', 'Módulo')}
...
class DataAnalysisSystem:
    ...
    def generate_report(self):
        ...
        print("\\n=== RELATÓRIO FINAL ===")
        print(f"Curso: {lesson_data.get('course', 'Curso')}")
        print(f"Módulo: {lesson_data.get('module', 'Módulo')}")
        print(f"Aula: {lesson_data.get('title', 'Aula')}")
        print(f"\\nResultados:")
...
"""
    ...
    def get_devops_example(self, lesson_data: Dict[str, Any]) -> str:
        ...
        return f"""# Pipeline DevOps Completo - {lesson_data.get('title', 'Aula')}
# Curso: {lesson_data.get('course', 'Curso')}
# Módulo: {lesson_data.get('module', 'Módulo')}
...
main() {{
    echo "🚀 Sistema de Monitoramento - {lesson_data.get('title', 'Aula')}"
    echo "Curso: {lesson_data.get('course', 'Curso')}"
    echo "Módulo: {lesson_data.get('module', 'Módulo')}"
    echo "=================================="
