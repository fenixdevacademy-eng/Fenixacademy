...
function generateSpecificLessonContent(moduleNumber, lessonNumber, moduleTitle, lessonTitle) {
    ...
    if (specificLessonContent[moduleKey] && specificLessonContent[moduleKey][lessonKey]) {
        return specificLessonContent[moduleKey][lessonKey].content;
    }
