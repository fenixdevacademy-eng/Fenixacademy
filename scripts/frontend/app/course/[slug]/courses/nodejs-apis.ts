...
export const nodejsapisCourse: CourseContent = {
    ...
    description: "Curso completo de node.js e apis backend com conteúdo CS50 expandido para 160 aulas",
    category: "Tecnologia",
    level: "Intermediário",
    duration_hours: 130,
    total_modules: 10,
    ...
    certificate: true,
    languages: ["pt-BR"],
    tags: ["Node.js e APIs Backend", "Programação", "Tecnologia", "CS50"],
