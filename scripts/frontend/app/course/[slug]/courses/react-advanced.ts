...
export const reactadvancedCourse: CourseContent = {
    id: "react-advanced",
    title: "React Avançado e Moderno",
    description: "Curso completo de react avançado e moderno com conteúdo CS50 expandido para 160 aulas",
    category: "Tecnologia",
    level: "Intermediário",
    duration_hours: 130,
    total_modules: 10,
    ...
    certificate: true,
    languages: ["pt-BR"],
    tags: ["React Avançado e Moderno", "Programação", "Tecnologia", "CS50"],
