...
export const pythondatascienceCourse: CourseContent = {
    ...
    description: "Curso completo de python para data science com conteúdo CS50 expandido para 160 aulas",
    category: "Tecnologia",
    level: "Intermediário",
    duration_hours: 130,
    total_modules: 10,
    ...
    certificate: true,
    languages: ["pt-BR"],
    tags: ["Python para Data Science", "Programação", "Tecnologia", "CS50"],
