...
export const fullstackdevelopmentCourse: CourseContent = {
    ...
    description: "Curso completo de full stack development com conteúdo CS50 expandido para 160 aulas",
    category: "Tecnologia",
    level: "Intermediário",
    duration_hours: 130,
    total_modules: 10,
    ...
    certificate: true,
    languages: ["pt-BR"],
    tags: ["Full Stack Development", "Programação", "Tecnologia", "CS50"],
