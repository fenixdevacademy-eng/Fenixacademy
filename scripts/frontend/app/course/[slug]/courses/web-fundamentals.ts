...
export const webfundamentalsCourse: CourseContent = {
    ...
    description: "Curso completo de fundamentos de desenvolvimento web com conteúdo CS50 expandido para 160 aulas",
    category: "Tecnologia",
    level: "Intermediário",
    duration_hours: 130,
    total_modules: 10,
    ...
    certificate: true,
    languages: ["pt-BR"],
    tags: ["Fundamentos de Desenvolvimento Web", "Programação", "Tecnologia", "CS50"],
