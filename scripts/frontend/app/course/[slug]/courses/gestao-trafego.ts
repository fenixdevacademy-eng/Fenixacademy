...
export const gestaotrafegoCourse: CourseContent = {
    id: "gestao-trafego",
    title: "Gestão de Tráfego",
    description: "Curso completo de gestão de tráfego com conteúdo CS50 expandido para 160 aulas",
    category: "Tecnologia",
    level: "Intermediário",
    duration_hours: 130,
    total_modules: 10,
    ...
    certificate: true,
    languages: ["pt-BR"],
    tags: ["Gestão de Tráfego", "Programação", "Tecnologia", "CS50"],
    thumbnail: "/images/courses/gestao-trafego.jpg",
    status: "active",
    modules: [
        {
            id: 1,
