#!/usr/bin/env python3
"""
Script para testar o dashboard do usuário Cezar Camara Lins
"""

import requests
import json

def test_cezar_dashboard():
    print("🧪 Testando dashboard do usuário Cezar Camara Lins...")
    
    # 1. Fazer login como Cezar
    print("\n1. Fazendo login como Cezar...")
    login_data = {
                ...
                if dashboard_response.status_code == 200:
                    ...
                    if dashboard_data.get('success'):
                        ...
                        if not missing_courses:
                            print(f"\n🎉 SUCESSO! Cezar tem acesso a TODOS os {len(expected_courses)} cursos da Fênix!")
                        else:
                            print(f"\n⚠️  Cezar está faltando {len(missing_courses)} cursos:")
